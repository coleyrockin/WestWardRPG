...
Latest local fast gate: `npm test` reports **871 passing tests across 78 files**. All Phase 1–6 roadmap items shipped. Run the verification commands below before committing gameplay changes.
