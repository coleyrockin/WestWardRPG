...
export const BARK_QUEST_OUTCOMES: Record<string, Record<string, Record<string, string>>>;
...
export function tryQuestOutcomeBark(runtime: any, questId: string, outcomeId: string, now?: number, opts?: any): string | null;
