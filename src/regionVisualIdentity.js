...
const REGION_PRESENTATION = {
  frontier: {
    anchor: { x: 9.5, y: 8.5 },
    routeLine: "marshal road east between fence rails, wagon ruts, hanging lamps, and the north watchtower",
    compositionLine: "bright wagon-rut road pulls the eye from Boone's board through paired lamps, split fences, and town posts toward the watchtower beacon",
    readability: {
    ...
    landmark: { kind: "landmark", variant: "watchtower", label: "North Watchtower Beacon", dx: 4.95, dy: -1.34, color: "#ffd77b", size: 1.76 },
    vistas: [
      { kind: "town", label: "Town Roofline", dx: 1.45, dy: -0.82, color: "#caa66c", size: 1.18 },
      { kind: "watchtower", label: "Watchtower Frame", dx: 4.25, dy: -1.72, color: "#ffd77b", size: 1.24 },
      ...
      { kind: "lamp", label: "Marshal Road Lantern Pair", dx: 2.9, dy: -0.18, color: "#ffe6a8", size: 0.72 },
    ],
    roads: [
      ...
      { kind: "road", label: "Road Chevron Stake", dx: 1.62, dy: -0.16, color: "#ffe6a8", size: 0.52 },
      { kind: "road", label: "East Road Chevron Stake", dx: 3.48, dy: 0.28, color: "#ffe6a8", size: 0.56 },
    ],
    props: [
      { kind: "sign", label: "Boone Road Sign", dx: 1.74, dy: 0.62, color: "#ffd77b", size: 0.82 },
      ...
      { kind: "wagon", label: "Broken Wagon Marker", dx: 3.72, dy: 0.72, color: "#ffbf63", size: 1.02 },
      { kind: "scorch", label: "Slime-Scarred Road", dx: 3.95, dy: 0.95, color: "#9fc17c", size: 0.58 },
      { kind: "lamp", label: "Road Lantern", dx: 4.25, dy: 0.55, color: "#ffd77b", size: 0.68 },
      { kind: "lamp", label: "Board Lantern", dx: 1.18, dy: -0.34, color: "#ffe6a8", size: 0.58 },
      { kind: "lamp", label: "Town Gate Lantern", dx: 2.58, dy: -0.42, color: "#ffe6a8", size: 0.56 },
      ...
      { kind: "sign", label: "Watchtower Arrow Sign", dx: 3.36, dy: -0.28, color: "#ffd77b", size: 0.64 },
    ],
  },
  ashfall: {
