...
const REGION_PRESENTATION = {
  frontier: {
    ...
    vistas: [
      ...
      { kind: "wagon", label: "Broken Wagon Silhouette", dx: 3.46, dy: 0.86, color: "#d89f62", size: 0.98, depthLane: "foreground" },
      { kind: "ranch", label: "Ranch Roof", dx: 0.52, dy: 1.24, color: "#9f7a4e", size: 0.78, depthLane: "foreground" },
      { kind: "lamp", label: "Marshal Road Lantern Pair", dx: 2.9, dy: -0.3, color: "#ffe6a8", size: 0.72, depthLane: "midground" },
    ],
    roads: [
    ...
    props: [
      ...
      { kind: "wagon", label: "Broken Wagon Marker", dx: 3.86, dy: 0.96, color: "#ffbf63", size: 1.12, depthLane: "foreground" },
      { kind: "scorch", label: "Slime-Scarred Road", dx: 4.05, dy: 1.18, color: "#9fc17c", size: 0.58, depthLane: "foreground" },
      ...
      { kind: "smoke", label: "Road Smoke", dx: 3.15, dy: 0.18, color: "#c8bfa4", size: 0.82, depthLane: "midground" },
