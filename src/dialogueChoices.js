    ...
    1: [
      {
        ...
        response: "Mayor Clem: A drifter's eye out there beats a council vote in here. I won't forget.",
      ...
      },
      {
        ...
        response: "Mayor Clem: Whoever's hungry. Sometimes that's the truth, sometimes that's the patrol.",
        effects: { axes: { truthVsComfort: 1, controlVsFreedom: -1 } },
      },
      {
        id: "elder_ch1_play_loyal",
        prompt: "I'm here to help the Council hold the line.",
        response: "Mayor Clem: Good. The line is older than most of us, and it pays.",
      ...
      },
      {
        ...
        response: "Mayor Clem: A returning marshal who knows where the seams open. I'll write you in.",
      ...
      },
      {
        ...
        response: "Mayor Clem: A defector with our handwriting. Quietly. Walk with me at dusk.",
    ...
    2: [
      {
        ...
        response: "Mayor Clem: Because some questions outlive the people who could answer them. Push anyway.",
      ...
      },
      {
        ...
        response: "Mayor Clem: Quietly is how I prefer to survive. I'll remember the favor.",
    ...
    3: [
      {
        ...
        response: "Mayor Clem: Then sign it for them. I'll back the script you write.",
    ...
    1: [
      {
        ...
        response: "Marshal Boone: Bring me badges, not promises. I'll mark you down anyway.",
      ...
      },
      {
        ...
        response: "Marshal Boone: Mine, when it's lonely. Council's, when there's a witness.",
        effects: { axes: { truthVsComfort: 1, controlVsFreedom: -1 } },
      },
      {
        id: "warden_ch1_share_drink",
        prompt: "I owe you a drink for the warning shots.",
        response: "Marshal Boone: I owe you a clean bounty. Even trade.",
      ...
      },
      {
        ...
        response: "Marshal Boone: Pretty argument. I'll countersign it before I think it through.",
    ...
    2: [
      {
        ...
        response: "Marshal Boone: I know. The sheet doesn't.",
      ...
      },
      {
        ...
        response: "Marshal Boone: I'll forget your name on the receipt.",
    ...
    3: [
      {
        ...
        response: "Marshal Boone: Then you read the first draft. I won't trust myself with it alone.",
    ...
    1: [
      {
        ...
        response: "Professor Cogwheel: Bring scrap, not stories. I'll show you the heat that matters.",
      ...
      },
      {
        ...
        response: "Professor Cogwheel: Cartel buys our coal twice. We sell the second one at the markup they wrote.",
      ...
      },
      {
        ...
        response: "Professor Cogwheel: Generous mouth. I'll remember it next time the Cartel asks who's loyal.",
      ...
      },
      {
        ...
        response: "Professor Cogwheel: A salvager who works for room. Bring it to the back door — and watch the cartel's eyes.",
    ...
    2: [
      {
        ...
        response: "Professor Cogwheel: I'll write your name on the door. Some doors are worth the names on them.",
      ...
      },
      {
        ...
        response: "Professor Cogwheel: I'll wait. But you'll know when the wait ended.",
    ...
    3: [
      {
        ...
        response: "Professor Cogwheel: Bring the lens. I'll bring the heat.",
    ...
    1: [
      {
        ...
        response: "Reverend Quill: Cartel cut. I keep the difference quiet, and you keep the discount quieter.",
      ...
      },
      {
        ...
        response: "Reverend Quill: Loyalty is the only inventory I never restock. Welcome to the ledger.",
      ...
      },
      {
        ...
        response: "Reverend Quill: An errandhand with my color of dust. Take a tin off the high shelf — call it sample.",
      ...
      },
      {
        ...
        response: "Reverend Quill: Sharp eye. Sharp tongue. Fine — first cut, but you don't tell anyone how you got it.",
    ...
    2: [
      {
        ...
        response: "Reverend Quill: A few things. I'll set a tin aside. You'll know it by the dust.",
    ...
    1: [
      {
        ...
        response: "Nora Knuckles: Three travelers, two patrols, and one rumor that's older than the paint.",
      ...
      },
      {
        ...
        response: "Nora Knuckles: That's how a frontier stays soft enough to live in. Thanks.",
