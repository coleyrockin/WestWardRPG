...
export const CODEX_ENTRIES = {
  ...
  letters: [
    ...
    { id: "frontier_sunken_coach", title: "Sunken Coach Ruins", body: "The coach manifest names six passengers and seven shadows. A marshal seal is scratched inside the door, as if someone locked in there still believed law could arrive late." },
    { id: "frontier_dry_gulch_hideout", title: "Dry Gulch Hideout", body: "A worn badge sits under outlaw cards. The badge is real, the oath is older than the blood on it, and Boone will know which deputy lost it." },
    { id: "frontier_saltback_stranger", title: "Saltback Stranger", body: "The sealed note is addressed in your hand before you write it. It says the safest roads are the ones that have not learned your name yet." },
    ...
    { id: "ashfall_cinder_mine", title: "Cinder Mine", body: "A shift clock stamps tomorrow again and again. The miner's helmet beside it is clean inside, which is worse than if it were not." },
    { id: "ashfall_glass_ruins", title: "Glassmaker Ruins", body: "Ashglass panes remember movement badly. Your reflection takes one step after you stop, then points back toward the road." },
    ...
    { id: "lantern_broken_relay", title: "Broken Relay", body: "The dead relay repeats one word in Boone's voice. It is not a warning until you hear it answer itself from farther down the road." },
    { id: "lantern_curfew_hideout", title: "Curfew Hideout", body: "The hideout door has a keyhole on both sides. Someone built this place to keep patrols out, then changed their mind about who should be free to leave." },
  ],
};
