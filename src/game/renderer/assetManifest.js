...
export const MODELS = {
  ...
  windowGlowPanel: { url: "/models/window_glow_panel.glb", scale: 0.46, light: { color: "#d87538", intensity: 0.08, distance: 1.7, decay: 2, height: 0.7 } },
  hangingSign: { url: "/models/hanging_sign.glb", scale: 0.58, light: { color: "#e5aa58", intensity: 0.07, distance: 1.6, decay: 2, height: 1.25 } },
