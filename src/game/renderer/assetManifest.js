...
export const MODELS = {
  ...
  brokenWagon: { url: "/models/wagon_wreck_hero.glb", scale: 1.0 },
  ...
  jobBoard: { url: "/models/jobBoard_max.glb", scale: 1.02, yaw: Math.PI / 2, light: { color: "#ffb86f", intensity: 1.85, distance: 4.2, decay: 2.1, height: 2.25 } },
  ...
  roadRut: { url: "/models/road_rut_strip.glb", scale: 1.0 },
  slimeTell: { url: "/models/marsh_slime_cluster.glb", scale: 1.0 },
  marshCluster: { url: "/models/marsh_slime_cluster.glb", scale: 1.0, vary: true },
