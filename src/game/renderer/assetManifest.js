...
export const MODELS = {
  ...
  saloon: { url: "/models/building_saloon.glb", scale: 2.1, windowLight: { color: "#ffb867", intensity: 1.45, distance: 6, height: 1.7 } },
  saloonFacade: { url: "/models/saloon_facade.glb", scale: 1.45, windowLight: { color: "#ffb867", intensity: 1.0, distance: 5.2, height: 1.55 } },
  townFacadeWarm: { url: "/models/town_facade_warm.glb", scale: 1.0, windowLight: { color: "#ffb867", intensity: 0.9, distance: 4.8, height: 1.45 } },
  townFacadeStore: { url: "/models/town_facade_store.glb", scale: 1.0, windowLight: { color: "#ffc070", intensity: 0.85, distance: 4.6, height: 1.35 } },
  townFacadeDark: { url: "/models/town_facade_dark.glb", scale: 1.0, windowLight: { color: "#ffad6a", intensity: 0.65, distance: 4.2, height: 1.25 } },
  storefront: { url: "/models/building_store.glb", scale: 2.0, windowLight: { color: "#ffc070", intensity: 1.25, distance: 5.5, height: 1.6 } },
  ...
  productionSaloon: { url: "/models/production_saloon.glb", scale: 1.0, windowLight: { color: "#ffad63", intensity: 1.5, distance: 6.2, height: 1.7 } },
  productionStore: { url: "/models/production_store.glb", scale: 1.0, windowLight: { color: "#ffbf72", intensity: 1.25, distance: 5.8, height: 1.55 } },
  productionAssay: { url: "/models/production_assay.glb", scale: 1.0, windowLight: { color: "#ff9f5d", intensity: 1.05, distance: 5.2, height: 1.45 } },
  windowGlowPanel: { url: "/models/window_glow_panel.glb", scale: 1.0, light: { color: "#ff9f4a", intensity: 1.15, distance: 3.8, decay: 2, height: 0.7 } },
  hangingSign: { url: "/models/hanging_sign.glb", scale: 1.0, light: { color: "#ffc66e", intensity: 0.65, distance: 3.0, decay: 2, height: 1.25 } },
  ...
  lanternString: { url: "/models/lantern_string.glb", scale: 1.0, light: { color: "#ff9f4a", intensity: 1.3, distance: 4.4, decay: 2, height: 1.75 } },
