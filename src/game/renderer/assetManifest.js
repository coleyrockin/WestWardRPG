...
export const MODELS = {
  ...
  saloon: { url: "/models/building_saloon.glb", scale: 2.1, windowLight: { color: "#e78f49", intensity: 0.82, distance: 4.6, height: 1.7 } },
  saloonFacade: { url: "/models/saloon_facade.glb", scale: 1.45, windowLight: { color: "#e78f49", intensity: 0.6, distance: 4.0, height: 1.55 } },
  townFacadeWarm: { url: "/models/town_facade_warm.glb", scale: 1.0, windowLight: { color: "#e79851", intensity: 0.56, distance: 3.8, height: 1.45 } },
  townFacadeStore: { url: "/models/town_facade_store.glb", scale: 1.0, windowLight: { color: "#eca158", intensity: 0.52, distance: 3.7, height: 1.35 } },
  townFacadeDark: { url: "/models/town_facade_dark.glb", scale: 1.0, windowLight: { color: "#d68145", intensity: 0.42, distance: 3.3, height: 1.25 } },
  storefront: { url: "/models/building_store.glb", scale: 2.0, windowLight: { color: "#eaa058", intensity: 0.74, distance: 4.4, height: 1.6 } },
  town: { url: "/models/building_house.glb", scale: 1.95, windowLight: { color: "#eaa058", intensity: 0.76, distance: 4.5, height: 1.5 } },
  ranch: { url: "/models/building_house.glb", scale: 2.05, windowLight: { color: "#eaa058", intensity: 0.76, distance: 4.5, height: 1.5 } },
  ...
  heroTownSaloon: { url: "/models/hero_town_saloon.glb", scale: 1.65, heightMul: 1.5, windowLight: { color: "#ffb867", intensity: 0.95, distance: 5.0, height: 1.55 } },
  heroTownStore: { url: "/models/hero_town_store.glb", scale: 1.6, heightMul: 1.5, windowLight: { color: "#ffc070", intensity: 0.82, distance: 4.7, height: 1.4 } },
  heroTownAssay: { url: "/models/hero_town_assay.glb", scale: 1.6, heightMul: 1.45, windowLight: { color: "#ffad6a", intensity: 0.62, distance: 4.2, height: 1.25 } },
  productionBoardwalk: { url: "/models/production_boardwalk.glb", scale: 1.35 },
  productionSaloon: { url: "/models/production_saloon.glb", scale: 1.65, heightMul: 1.55, windowLight: { color: "#dc8342", intensity: 0.68, distance: 4.4, height: 1.7 } },
  productionStore: { url: "/models/production_store.glb", scale: 1.6, heightMul: 1.5, windowLight: { color: "#e59b52", intensity: 0.58, distance: 4.1, height: 1.55 } },
  productionAssay: { url: "/models/production_assay.glb", scale: 1.6, heightMul: 1.45, windowLight: { color: "#d57a3e", intensity: 0.48, distance: 3.7, height: 1.45 } },
  ...
  lanternString: { url: "/models/lantern_string.glb", scale: 1.0, light: { color: "#df7f3c", intensity: 0.62, distance: 3.2, decay: 2, height: 1.75 } },
