...
export const PALETTES = Object.freeze({
  ...
  dusk: {
    ...
    hemi: { sky: "#4a4478", ground: "#1e0e04", intensity: 0.18 },
    rim: { color: "#4a5fff", intensity: 1.0, dir: { x: 9, y: 5, z: 6 } },
    exposure: 1.1,
    stars: 0.1,
    bloom: 0.85,
    grade: { tint: "#ff9a4a", amount: 0.3, contrast: 1.55, saturation: 1.4, shadowTint: "#1a0a2e", highlightTint: "#ffb040" },
    bodyBg: "#1a1226",
  },
  goldenHour: {
    key: "goldenHour",
    ...
    hemi: { sky: "#8aa0d0", ground: "#3a2a18", intensity: 0.24 },
    rim: { color: "#6a8fff", intensity: 0.85, dir: { x: 9, y: 5, z: 6 } },
    exposure: 1.32,
    stars: 0,
    bloom: 0.55,
    grade: { tint: "#ffb060", amount: 0.3, contrast: 1.5, saturation: 1.45, shadowTint: "#241040", highlightTint: "#ffc060" },
    bodyBg: "#2a1f2e",
  },
  night: {
    key: "night",
    ...
    hemi: { sky: "#20284a", ground: "#050507", intensity: 0.16 },
    rim: { color: "#6a7aff", intensity: 0.5, dir: { x: -7, y: 4, z: 6 } },
    exposure: 0.82,
    stars: 1.0,
    bloom: 1.2,
    grade: { tint: "#5a6bd0", amount: 0.28, contrast: 1.6, saturation: 1.3, shadowTint: "#0a1230", highlightTint: "#9ab0ff" },
    bodyBg: "#05060f",
  },
});
