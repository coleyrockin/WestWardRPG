...
export const PALETTES = Object.freeze({
  ...
  dusk: {
    ...
    sun: { color: "#ffb24a", intensity: 2.2, dir: { x: -10, y: 3.5, z: -5 }, disc: 0.028, glow: 0.2 },
    hemi: { sky: "#4a4478", ground: "#1e0e04", intensity: 0.34 },
    rim: { color: "#5a6bd0", intensity: 0.55, dir: { x: 9, y: 5, z: 6 } },
    exposure: 1.1,
    stars: 0.1,
    bloom: 0.85,
    grade: { tint: "#ff9a4a", amount: 0.16 },
    bodyBg: "#1a1226",
  },
  goldenHour: {
    key: "goldenHour",
    ...
    sun: { color: "#ffcf86", intensity: 2.5, dir: { x: -12, y: 3, z: -4 }, disc: 0.034, glow: 0.22 },
    hemi: { sky: "#8aa0d0", ground: "#3a2a18", intensity: 0.4 },
    rim: { color: "#7aa0ff", intensity: 0.45, dir: { x: 9, y: 5, z: 6 } },
    exposure: 1.32,
    stars: 0,
    bloom: 0.55,
    grade: { tint: "#ffb060", amount: 0.16 },
    bodyBg: "#2a1f2e",
  },
  night: {
    key: "night",
    ...
    hemi: { sky: "#20284a", ground: "#050507", intensity: 0.28 },
    rim: { color: "#ff9a5a", intensity: 0.22, dir: { x: -7, y: 4, z: 6 } },
    exposure: 0.82,
    stars: 1.0,
    bloom: 1.2,
